...
Training trajectories are generated by random walks on a k-nearest-neighbor graph whose transition probabilities are biased by a prior pseudotime ordering and, when available, lineage constraints. Thus, LSD learns continuous dynamics conditioned on an initial temporal prior rather than inferring temporal ordering completely de novo.
